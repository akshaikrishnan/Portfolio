(function ($) {
  ...
  function dsnAjax() {
    ...
    return {
      ...
      dsnCreateElement: function (
        ...
        if (!title_move.find(".dsn-chars-wrapper").length)
      ...
      completeElement: function (elAjax) {
        ...
        if (title_move.length) {
          ...
          tl.set(
            title_move.find(".dsn-chars-wrapper"),
            {
      ...
      translateSection: function () {
        $(".section-image.section-move-image .transform-move-section").each(
          function () {
            ...
            $(this).append($(this).find(".swiper-slide").clone());
            width -= $(this).width();
            if ($(this).hasClass("move-left")) tl.to(this, { x: width * -1 });
  ...
  function initMap() {
    ...
    if (!mapScriptId.length) {
      let GOOGLE_MAP_KEY = "AIzaSyCnsjCwTTv0YuMEPY4xurDKRCN0SNq8sEo";
